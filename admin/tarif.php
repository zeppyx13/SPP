                    ...
                    <?php foreach ($data as $row) : ?>
                        <tr>
                            ...
                            <td>
                                <?php
                                $id_cek = $row['id'];
                                $query = mysqli_query($konek, "SELECT kelas.idtarif, tarif.id FROM kelas INNER JOIN tarif on kelas.idtarif=tarif.id WHERE tarif.id='$id_cek'");
                                $cek = mysqli_num_rows($query);
                                if ($cek == 0) {
                                ?>
                                    <a class="icon-hps" onclick="return confirm('Yakin ingin menghapus tarif angkatan : <?= $row['Angkatan'] ?>')" href="../config/action/delete/all.php?id=<?= $row['id'] ?>&tabel=tarif&primary=id">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="curentcolor" viewBox="0 0 24 24">
                                ...
                                <?php }
                                ?>
                                <a class="icon-edit" href="../config/action/update/tarif.php?id=<?= $row['id'] ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="curentcolor" viewBox="0 0 24 24">
