                ...
                <tbody>
                    ...
                    <?php foreach ($data as $row) : ?>
                        <tr>
                            ...
                            <td><?= $row["jurusan"] ?></td>
                            <td><?= $row["Nominal"] ?></td>
                            <td><a onclick="return confirm('Yakin ingin menghapus kelas : <?= $row['kelas']; ?> <?= $row['jurusan']; ?>')" class="icon-hps" href="../config/action/delete/all.php?id=<?= $row['idkelas'] ?>&tabel=kelas&primary=idkelas">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="curentcolor" viewBox="0 0 24 24">
